...
One process, one port, six streamable-http MCP mounts plus a deterministic
...
def build_app() -> Starlette:
    servers = (main_mcp, conformance_mcp, second_mcp, apikey_mcp, oauth_mcp, oauthuser_mcp)
