...
from litellm.proxy.management_endpoints.services_management_endpoints import (
    router as services_management_router,
)
...
app.include_router(services_management_router)
