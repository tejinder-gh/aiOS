# Contributing to the aiOS UI

The aiOS UI is currently being refactored/rewritten to reduce development friction. Please read this document to understand what's expected for new contributions.
